...
struct discard_cmd_control {
	...
	unsigned int odiscard_wake;	/* to wake up discard ,for odiscard */
	unsigned int otrim_wake;	/* to wake up discard ,for otrim */
#endif
...
/* 120 s, if no candidates */
#define DEF_MAX_DISCARD_ISSUE_TIME_OF2FS	120000
/* 10 min, undiscard block=0 */
